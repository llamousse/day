...
// add endpoint for GET. It should call `Post.get()`
...
// blog post to be added (using `Post.create()`). It should
// return a JSON object representing the new post (including
// the id, which `Post` will create. This endpoint should
...
// call `Post.update()` and return the updated post.
